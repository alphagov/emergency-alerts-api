...
def test_dao_get_all_finished_broadcast_messages_with_outstanding_actions(sample_broadcast_service):
    ...
    create_broadcast_message(
        # Cancelled: never picked up by this job, as cancelling already triggers its own
        # GOV.UK publish. Included here to prove it is excluded even when unacknowledged
        # and cancelled long ago.
        t,
        created_at=datetime(2023, 10, 12, 12, 0, 0),
