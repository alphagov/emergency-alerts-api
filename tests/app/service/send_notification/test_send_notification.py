...
# @pytest.mark.parametrize("template_type, to", [(SMS_TYPE, "+447700900855"), (EMAIL_TYPE, "ok@ok.com")])
...
#             json_data = json.dumps({"to": "+447700900855", "template": sample_template.id})
#             auth_header = create_service_authorization_header(service_id=sample_template.service_id)
...
# @pytest.mark.parametrize(
#     "template_type, to", [(SMS_TYPE, "+447700900855"), (EMAIL_TYPE, "not-someone-we-trust@email-address.com")]
# )
...
#             data = {"to": "07700 900 855", "template": str(sample_template.id)}
...
# def test_should_allow_api_call_if_under_day_limit_regardless_of_type(notify_api, sample_user, mocker, restricted):
#     with notify_api.test_request_context():
#         with notify_api.test_client() as client:
...
#     data = {"to": sample_template.service.created_by.mobile_number, "template": sample_template.id}
#     api_key = ApiKey(
...
#     client, sample_template, sample_email_template, fake_uuid, mocker, template_type, queue_name
# ):
#     mocked = mocker.patch("app.celery.provider_tasks.deliver_{}.apply_async".format(template_type))
#     mocker.patch("app.notifications.process_notifications.uuid.uuid4", return_value=fake_uuid)
...
#     client, sample_email_template, sample_template, fake_uuid, mocker, template_type, queue_name
# ):
#     mocked = mocker.patch(
...
# @pytest.mark.parametrize("to_sms", ["07700 900000", "07700 900111", "07700 900222"])
...
# @pytest.mark.parametrize(
#     "notification_type, to", [(SMS_TYPE, "07827992635"), (EMAIL_TYPE, "non_guest_list_recipient@mail.com")]
# )
...
# @pytest.mark.parametrize("key_type", [KEY_TYPE_NORMAL, KEY_TYPE_TEAM])
# @pytest.mark.parametrize(
#     "notification_type, to", [(SMS_TYPE, "07123123123"), (EMAIL_TYPE, "guest_list_recipient@mail.com")]
# )
...
#     [(EMAIL_TYPE, SMS_TYPE, "notify@digital.cabinet-office.gov.uk"), (SMS_TYPE, EMAIL_TYPE, "+447700900986")],
# )
...
#     data = {"to": "07700-900-123", "template": str(template.id)}
...
#     data = {"to": "+447700900986", "template": str(sample_template_without_sms_permission.id)}
...
# @pytest.mark.parametrize("notification_type, recipient", [("sms", "07700 900 855"), ("email", "test@gov.uk")])
# def test_post_notification_should_set_reply_to_text(client, sample_service, mocker, notification_type, recipient):
