...
Revision ID: 0405_drop_notify_organisation_fields
...
revision = "0405_drop_notify_organisation_fields"
...
def upgrade():
    ...
    op.drop_column("organisation", "billing_contact_email_address")
