...
def upgrade():
    ...
    op.add_column(
        "services_history", sa.Column("dvla_organisation_id", sa.String(), nullable=True, server_default="001")
    )
    ...
    op.create_index(op.f("ix_services_dvla_organisation_id"), "services", ["dvla_organisation_id"], unique=False)
    op.create_index(
        op.f("ix_services_history_dvla_organisation_id"), "services_history", ["dvla_organisation_id"], unique=False
    )
