...
class Config(object):
    ...
    COMMON_PASSWORDS_BUCKET_NAME = os.environ.get("COMMON_PASSWORDS_BUCKET_NAME", "")
    COMMON_PASSWORDS_FILEPATH = os.environ.get("COMMON_PASSWORDS_FILEPATH", "passwords.txt")
